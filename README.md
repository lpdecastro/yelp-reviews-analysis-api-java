...
<p>Retrieves reviews from any businesses using the <strong>Yelp API</strong> and analyzes its reviews using <strong>Google Natural Language API</strong> (sentiment analysis) and <strong>Cloud Vision API.</strong></p> (image analysis - face detection)
